...
# 模型训练
def train_model(X_train, y_train, kernel='rbf', C=1.0, epsilon=0.1):
...
def main():
    # 加载并预处理数据
    file_path = '/mnt/random_forest/data/GBM_dataset.jsonl'  # 替换为你的文件路径
    ...
    _ = evaluate_model(model, X_test, y_test, target_scaler)
